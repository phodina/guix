...
(define-public akonadi
  (package
    ...
    (native-inputs (list dbus extra-cmake-modules qttools-5 shared-mime-info
                         pkg-config))
    (inputs (list boost
                  libaccounts-qt
                  kconfig
    ...
    (arguments
     (list #:tests? #f
           ...
           #:phases #~(modify-phases (@ (guix build qt-build-system)
                                        %standard-phases)
                        (replace 'check
...
(define-public kaccounts-integration
  (package
    ...
    (synopsis "Online account management system and its Plasma integration components")
...
(define-public kalendar
  (package
    ...
    (synopsis
     "Calendar application using Akonadi to sync with external services")
    (description "")

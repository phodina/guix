  ...
  (package
    ...
    (source
     (origin
       (method git-fetch)
       (uri (git-reference
       (url "https://gitlab.com/librewolf-community/browser/source.git")
	    (commit version)))
       (sha256
    ...
    (synopsis "Fork of Firefox, focused on privacy, security and freedom")
    (description "This package provides a fork of Firefox, focused on privacy,

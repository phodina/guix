...
;;;
(define-public rust-atk-sys-0.15
  (package
    (name "rust-atk-sys")
    (version "0.15.1")
    (source (origin
...
(define-public rust-atk-0.15
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1pfympjvlhvv4rzjvy8y1cvl9w5gq88nj3c3jsd91qphwrn82g9c"))))
    (build-system cargo-build-system)
    (arguments
     `(#:skip-build? #t
...
(define-public rust-cairo-rs-0.15
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1g396fdz8crf74dmmjarcsdbsm8qgxy3a5x9kw6m2d9xn28y6vn7"))))
    (build-system cargo-build-system)
    (arguments
     `(#:skip-build? #t
...
(define-public rust-cairo-sys-rs-0.15
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1j6k4pps3dv6g0vlpmxc2xyk0s40vj2wpzi55lbwjspmpqlx8m9w"))))
    (build-system cargo-build-system)
    (arguments
     `(#:skip-build? #t
       #:cargo-inputs (("rust-glib-sys" ,rust-glib-sys-0.15)
...
(define-public rust-gdk-pixbuf-0.15
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "16k1z21r76m620z61kfmgid1n6s8dnxpa4zlrppcr6dhr2fdsf5d"))))
    (build-system cargo-build-system)
    (arguments
     `(#:skip-build? #t
       #:cargo-inputs (("rust-bitflags" ,rust-bitflags-1)
...
(define-public rust-gdk-pixbuf-sys-0.15
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "19q2qjrzmmgc7bbs59sk6k0sv3xhpmnk9a2h0cajfr95g19jy2ql"))))
    (build-system cargo-build-system)
    (arguments
     `(#:skip-build? #t
       #:cargo-inputs (("rust-gio-sys" ,rust-gio-sys-0.15)
...
(define-public rust-gio-0.15
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0fr8qiqjf9yzl8867kgqdsxpkcx2jrns3xwmlf0jfiid668brzb8"))))
    (build-system cargo-build-system)
    (arguments
     `(#:skip-build? #t
       #:cargo-inputs (("rust-bitflags" ,rust-bitflags-1)
...
(define-public rust-glib-0.15
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0pahikbwxr3vafdrr5l2hnlhkf9xi4illryan0l59ayhp9pk1c7d"))))
    (build-system cargo-build-system)
    (arguments
     `(#:skip-build? #t
       #:cargo-inputs (("rust-bitflags" ,rust-bitflags-1)
...
(define-public rust-glib-macros-0.15
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0r3cr0c79rs91z0sps089nsf8ppnm8agp48qwwqlkc32lqqq39i5"))))
    (build-system cargo-build-system)
    (arguments
     `(#:skip-build? #t
...
(define-public rust-gobject-sys-0.15
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "02hyilvpi4hw4gr03z2plsbf1zicsfs5l0xxadqx3v3b4i2cwmqd"))))
    (build-system cargo-build-system)
    (arguments
     `(#:skip-build? #t
       #:cargo-inputs (("rust-glib-sys" ,rust-glib-sys-0.15)
...
(define-public rust-gtk-0.15
  (package
    ...
    (build-system cargo-build-system)
    (arguments
     `(#:tests? #f ; Fails to build test see
       ;; https://github.com/gtk-rs/gtk3-rs/issues/768
       #:cargo-inputs (("rust-atk" ,rust-atk-0.15)
                       ("rust-bitflags" ,rust-bitflags-1)
                       ("rust-cairo-rs" ,rust-cairo-rs-0.15)
...
(define-public rust-pango-0.15
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0ksf85fqkw4y5pf21p84g5xn4fnqn21cbrmx2d9yx6k591ah9r12"))))
    (build-system cargo-build-system)
    (arguments
     `(#:skip-build? #t
       #:cargo-inputs (("rust-bitflags" ,rust-bitflags-1)
...
(define-public rust-pango-sys-0.15
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1an3c931kbkr08n9d9d1dapsq3n26zs0xn4ixn11jrp4rn0h186j"))))
    (build-system cargo-build-system)
    (arguments
     `(#:skip-build? #t
       #:cargo-inputs (("rust-glib-sys" ,rust-glib-sys-0.15)

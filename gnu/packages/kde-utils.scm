  ...
  (package
    ...
    (source
     (origin
       (method url-fetch)
       (uri (string-append
	   "https://invent.kde.org/graphics/pikasso/-/archive/" commit "/pikasso-"
	   commit ".tar.gz"))
       (sha256
        (base32
	...
	(native-inputs (list extra-cmake-modules))
	;; TODO: Missing Corrosion
	(inputs (list kirigami ki18n qtdeclarative-5 qtbase-5 qtquickcontrols2-5 qtsvg-5))
    (home-page

...
(define-public fielding
  (let ((commit "6b3c5d67b308e9e7e2043dc6072bfd265ec9f3e1")
    ...
    (package
      ...
      (description "This package provides REST API testing tool.")
...
(define-public isoimagewriter
  (let ((commit "bd1ef4f0ce179fa874b102689022ebda3e7b4c16")
    ...
    (package
      ...
      (synopsis "Program to write hybrid ISO files onto USB disks")
      (description
       "This package provides tool to write ISO files to USB disks.")
      (license license:gpl3+))))
...
@itemize
@item profile for Folders and files to be included or excluded from the
backup
...
(define-public kcalc
  (package
    ...
    (description "This package provides scientific calculator.")
    (license license:gpl2+)))
...
(define-public kdialog
  (package
    ...
    (synopsis "Tool to show nice dialog boxes from shell scripts")
...
(define-public keurocalc
  (let ((commit "a760d8a7e58b36eb72d15e847f96599c93785194") ; just one release
    ...
    (package
      ...
      (synopsis
       "Utility to handle currency conversions between European currencies")
      (description "This package provides uitility to handle currency
...
(define-public kfind
  (package
    ...
    (description "This is the file search utility.")
    (license license:gpl2+)))
...
(define-public print-manager
  (package
	...
	(inputs (list cups kconfig kconfigwidgets kcoreaddons kdbusaddons
  kiconthemes ki18n kcmutils kio knotifications plasma-framework kwidgetsaddons
  kwindowsystem qtdeclarative-5))
    (home-page "https://invent.kde.org/utilities/print-manager")
    (synopsis "Tool for managing print jobs and printers")
    (description "This package provides printing management for KDE.")
    (license license:gpl2+)))

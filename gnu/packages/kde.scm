...
(define-public kopeninghours
  (package
    ...
    (description "This package provides library to parse and e 
map.")
    (license license:lgpl2.0+)))
...
(define-public kosmindoormap
  (package
    ...
    (synopsis "OSM multi-floor indoor map renderer")
    (description "This package provides rendering for OSM multi-floor indoor
map.")
    (license license:lgpl2.0+)))

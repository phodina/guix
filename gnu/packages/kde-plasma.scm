...
(define-public plasma-mobile-settings
  (package
	...
	(inputs (list qtbase-5 qtdeclarative kio modemmanager-qt networkmanager-qt
	ki18n plasma-framework kdeclarative kdbusaddons))
    (home-page "https://www.plasma-mobile.org/")
...
kwin	kcodecs kcompletion kconfig kconfigwidgets kcoreaddons kdbusaddons kdeclarative ki18n kio kitemviews kjobwidgets knotifications kpackage kpeople kservice kwayland kwidgetsaddons kwindowsystem kxmlgui libphonenumber modemmanager-qt plasma-framework solid))
    (home-page "https://www.plasma-mobile.org/")
...
(define-public plasma-mobile-sounds
  (package
    ...
    (source (origin
              (method url-fetch)
              (uri (string-append
			  "https://download.kde.org/stable/plasma-mobile-sounds/" version
			  "/plasma-mobile-sounds-" version ".tar.xz"))
              (sha256
               (base32

...
(define-public squeekboard
 ...
 (lambda* (#:key outputs configure-flags build-type
  ...
  (let* ((source-dir (getcwd))
         (build-dir "../build")
         (prefix #$output)
         (args (list (string-append "--prefix=" prefix)
    ...
    (apply invoke "meson" args))))
                        (add-after 'meson-configure 'meson-build
(lambda* (#:key parallel-build?
                #:allow-other-keys)
...
(define-public phosh
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "19rgrdb655vnjvwy89fl335zhlc1bqc20432iwwy8yqj0ayfs6ds"))))
    (build-system meson-build-system)
    (arguments
                          ...
                          (lambda* (#:key inputs #:allow-other-keys)
                            ...
                            (copy-recursively #$(origin
                                                  ...
                                                  (uri (git-reference (url
                                                                      ...
                                                                      (commit
                                                                       "f81f46045ac85e5c5c93d9b5be673c0f20991927")))
                                                  (file-name (string-append
                                                              name "-" version
                                                              "-checkout"))
                                                  (sha256 (base32
                                                           "1sb6z8ll6088kh3idxlzvavgs1dcixr6n4ykcjkxhfhhyfgdc8an")))
